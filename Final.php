...
// Query untuk mengambil data mobil berdasarkan filter
$query = "SELECT * FROM list_mobil";
if ($filter !== 'Semua') {
    $query .= " WHERE tipe = '$filter'";
}
$result = $conn->query($query);
$list_mobil = $result->fetch_all(MYSQLI_ASSOC);
?>
  ...
  <div class="container">
    ...
    <div class="offcanvas-header" style="border-bottom: 1px solid black;">
      ...
      <div class="offcanvas-body d-flex flex-column flex-lg-row p-4 p-lg-0">
        ...
        <a href="Login/logout.php" class="text-danger">Logout</a> <!-- Tombol Logout -->
    <?php else: ?>
